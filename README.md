...
It is a single GO script (package) of ~ 1000 lines of code (without blanks and comments), plus a
main script (binary) of 190 loc.
...
All the *btrfs-diff-go* source codes (every file but README.md, CODE_OF_CONDUCT.md and LICENSE) are
licensed under the _GPLv3+_ license.
